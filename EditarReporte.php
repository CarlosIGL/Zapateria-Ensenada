...
$consulta = "SELECT * from reportventas WHERE Id_Reportes = '$id'";
...
<main role="main">
    ...
    <div class="container">
        <div class="container-add">
            <h2 class="container__title">Editar  reporte</h2>
            <?php
            foreach ($result as $row):
            ?>
            <form action="EditarReportedb.php?id=<?php echo $row['Id_Reportes']?>" method="post" class="container__form" enctype="multipart/form-data">

                <label for="" class="container__label">TIPO: </label>
                <input type="text"  class="container__input" name="tipo" placeholder="<?= $row['TIPO']; ?>" required>
                <label for="" class="container__label">MARCA: </label>
                <input type="text" class="container__input" name="marca" placeholder="<?= $row['MARCA']; ?>" required>
                <label for="" class="container__label">UNIDADES VENDIDAS:</label>
                <input type="number" class="container__input" name="uni" placeholder="<?= $row['UNIDAD_VEND']; ?>" required>
                <label for="" class="container__label">UNIDADES EN STOCK: </label>
                <input type="number" class="container__input" name="total" placeholder="<?= $row['MONTO_TOTAL']; ?>" required>
                <label for="" class="container__label">  </label>
                <input  type="submit" class="container__submit" value="Guardar Cambios">
