...
$consulta = "SELECT * from altazapatos WHERE Id_Zapatos = '$id'";
...
<main role="main">
    ...
    <div class="container">
        ...
        foreach ($result as $row):
            ?>
            <form action="EditarZapatosdb.php?id=<?php echo $row["Id_Zapatos"];?>" method="post" enctype="multipart/form-data">
                <div class="row featurette">
                    <div class="col-md-4">
                        <h2 class="featurette-heading">PRECIO: </h2>
                        <div class="form-group">
                            <input class="form-control" type="text" name="precioZapatos" placeholder="$<?= $row['PRECIO']; ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="modeloZapatos" placeholder="<?= $row['MODELO']; ?>"  required>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="colorZapatos" placeholder="<?= $row['COLOR']; ?>"  required>
                        </div>
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="tallasZapatos" placeholder="<?= $row['TALLAS']; ?>"  required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="imagenZapatos" required/>
                        </div>
