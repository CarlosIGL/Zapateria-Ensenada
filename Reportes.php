...
$consulta = "SELECT * from reportventas";
...
<div class="fondo jumbotron">
    <div class="container-fluid">
        <div class="d-flex justify-content-center">
            <h2 class="featurette-heading">REPORTES.</h2>
        </div>
        <br>
    </div>
</div>
...
<main role="main">
    ...
    <div class="container">
        <div class="container-add">
            <h2 class="container__title">Registrar reporte</h2>
            <form action="Reportedb.php" method="post" class="container__form" enctype="multipart/form-data">
                <label for="" class="container__label">TIPO: </label>
                <input type="text" class="container__input" name="tipo" required>
                <label for="" class="container__label">IMAGEN: </label>
                <input type="file" class="container__input" name="imagen" required>
                <label for="" class="container__label">MARCA: </label>
                <input type="text" class="container__input" name="marca" required>
                <label for="" class="container__label">UNIDADES VENDIDAS:</label>
                <input type="number" class="container__input" name="uni" required>
                <label for="" class="container__label">UNIDADES EN STOCK: </label>
                <input type="number" class="container__input" name="total" required>
                <label for="" class="container__label">  </label>
                <input  type="submit" class="container__submit" value="Generar Reporte">
            ...
            <div class="container-table container-table--edit">
                ...
                <div class="table__header">UNIDADES VENDIDAS</div>
                <div class="table__header">STOCK</div>
                <div class="table__header">OPERACION</div>
                <?php  foreach ($result as $row): ?>
                <div class="table__item"><?php echo $row['TIPO']; ?></div>
                <div class="table__item"><img src="<?php echo $row['IMAGEN']; ?>" width="30" height="30"></div>
                <div class="table__item"><?php echo $row['MARCA']; ?></div>
                <div class="table__item"><?php echo $row['UNIDAD_VEND']; ?></div>
                <div class="table__item"><?php echo $row['MONTO_TOTAL']; ?></div>
                <div class="table__item">
                    <a href="EditarReporte.php?id=<?php echo $row['Id_Reportes']; ?>" >Editar</a>/
                    <a href="EliminarReporte.php?id=<?php echo $row['Id_Reportes']; ?>" >Eliminar</a>
                </div>
                <?php endforeach;?>
            </div>
            <hr>
