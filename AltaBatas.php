...
<div class="fondo jumbotron">
    <div class="container-fluid">
        <div class="d-flex justify-content-center">
            <h2 class="featurette-heading">ALTAS BATAS.</h2>
        </div>
        <br>
    </div>
</div>
...
<main role="main">
    ...
    <div class="container">
        <form action="AltasBatasdb.php" method="post" enctype="multipart/form-data">
            <div class="row featurette">
                <div class="col-md-4">
                    <h2 class="featurette-heading">PRECIO: </h2>
                    <div class="form-group">
                        <input class="form-control" type="text" name="precioBatas"  required>
                    </div>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="modeloBatas"  required>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="colorBatas"  required>
                    </div>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="tallasBatas"  required>
                    </div>
