...
$consulta = "SELECT Id_Batas, IMAGEN from altabatas";
...
<div class="fondo jumbotron">
    <div class="container-fluid">
        <div class="d-flex justify-content-center">
            <h2 class="featurette-heading">MODIFICAR PRODUCTOS.</h2>
        </div>
        <br>
    </div>
</div>
        ...
        <div class="row justify-content-center text-center">
            ...
            foreach ($result as $row):
                ...
                <div class="col-lg-4 col-xl-4 col-md-4 col-sm-6 pb-2">
                    ...
                    <hr>
                    <p><a href="EditarBatas.php?id=<?php echo $row["Id_Batas"];?>" class="btn btn-secondary"  role="button" >Modificar &raquo;</a></p>
                </div>
            <?php
            endforeach;
            ?>
