...
$consulta = "SELECT * from altaropa WHERE Id_Ropa = '$id'";
...
<main role="main">
    ...
    <div class="container">
        ...
        foreach ($result as $row):
            ?>
            <form action="EditarRopadb.php?id=<?php echo $row["Id_Ropa"];?>" method="post" enctype="multipart/form-data">
                <div class="row featurette">
                    <div class="col-md-4">
                        <h2 class="featurette-heading">PRECIO: </h2>
                        <div class="form-group">
                            <input class="form-control" type="text" name="precioRopa" placeholder="$<?= $row['PRECIO']; ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="modeloRopa" placeholder="<?= $row['MODELO']; ?>"  required>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="colorRopa" placeholder="<?= $row['COLOR']; ?>"  required>
                        </div>
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="tallasRopa" placeholder="<?= $row['TALLAS']; ?>"  required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="imagenRopa" required/>
                        </div>
