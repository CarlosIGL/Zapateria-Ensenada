...
$consulta = "SELECT * from altadama WHERE Id_Dama = '$id'";
...
<main role="main">
    ...
    <div class="container">
        ...
        ?>
        <form action="EditarDamadb.php?id=<?php echo $row["Id_Dama"];?>" method="post" enctype="multipart/form-data">
            <div class="row featurette">
                <div class="col-md-4">
                    <h2 class="featurette-heading">PRECIO: </h2>
                    <div class="form-group">
                        <input class="form-control" type="text" name="precioDama" placeholder="$<?= $row['PRECIO']; ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="modeloDama" placeholder="<?= $row['MODELO']; ?>"  required>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="colorDama" placeholder="<?= $row['COLOR']; ?>"  required>
                    </div>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="tallasDama" placeholder="<?= $row['TALLAS']; ?>"  required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="imagenDama" required/>
                    </div>
