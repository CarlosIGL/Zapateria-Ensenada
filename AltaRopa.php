...
<div class="fondo jumbotron">
    <div class="container-fluid">
        <div class="d-flex justify-content-center">
            <h2 class="featurette-heading">ALTAS ROPA.</h2>
        </div>
        <br>
    </div>
</div>
...
<main role="main">
    ...
    <div class="container">
        <form action="AltasRopadb.php" method="post" enctype="multipart/form-data">
            <div class="row featurette">
                <div class="col-md-4">
                    <h2 class="featurette-heading">PRECIO: </h2>
                    <div class="form-group">
                        <input class="form-control" type="text" name="precioRopa"  required>
                    </div>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="modeloRopa"  required>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="colorRopa"  required>
                    </div>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="tallasRopa"  required>
                    </div>
