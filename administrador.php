...
<div class="fondo jumbotron">
    <div class="container-fluid">
        <h2 class="featurette-heading">BIENVENID@ AL MODO ADMINISTRADOR.</h2>
        <p>En esta seccion de la pagina se prodran dar de alta, de baja los productos ademas de que se podran hacer modificaciones en la informacion de los productos.</p>
        <br>
    </div>
</div>
